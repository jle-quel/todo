...
func initialize(environ Environ) error {
	var todo	Todo
	var err error

	if err = parse_initialize(environ.Argv); err != nil {
		return err
	}
	if err = create_repository(environ.Pwd + "/.todo"); err != nil {
		return err
	}
	...
	if err = write_file(environ.Pwd + "/.todo/tasks", todo); err != nil {
		return err
	}
	if err = write_file(environ.Pwd + "/.todo/branch", "master"); err != nil {
		return err
	}
